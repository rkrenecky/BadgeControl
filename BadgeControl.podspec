#
#  Be sure to run `pod spec lint BadgeControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Robin Krenecky"
  # s.authors            = { "Robin Krenecky" => "rkrenecky@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Robin Krenecky"
  ...
  s.source       = { :git => "https://github.com/kiwisip/BadgeControl.git", :tag => "1.0.3" }
